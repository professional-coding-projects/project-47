...
function draw() {
  ...
  fill("red");
  textSize(35);
  text("zombie kills: " + score, windowWidth / 2 - 100, 100);
  if (gameState === "fight") {
  ...
  if (gameState == "lost") {
    ...
    swal({
      ...
      imageUrl:"https://thumbs.dreamstime.com/x/concept-lost-game-futuristic-background-animation-glitch-effect-futuristic-game-background-animation-retro-140416583.jpg",
      imageSize:"300x300",
...
function enemy() {
  if (frameCount % 50 === 0) {
    ...
    zombie = createSprite(random(700, 1500), random(400, 850), 40, 40)
